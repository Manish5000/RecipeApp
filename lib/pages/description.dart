                  ...
                  Row(children: [Icon(Icons.photo),
                     ...
                     // Smallbutton(color1: Color(0xFF6c60e0),color2: Colors.white,name: 'Cancel',)
                      ...
                      Row( 
                       ...
                       children: <Widget>[
                        Container(
                          decoration: BoxDecoration(borderRadius: BorderRadius.circular(25), image: DecorationImage(fit: BoxFit.cover,image: AssetImage('assets/vanilla1.webp'),)),
                          height: 100,
                          width: 100,
                        ...
                        SizedBox(width: 10,),
                        Container(
                          decoration: BoxDecoration(borderRadius: BorderRadius.circular(25), image: DecorationImage(fit: BoxFit.cover,image: AssetImage('assets/vanilla2.jpg'),)),
                          height: 100,
                          width: 100,
                        ),
                        SizedBox(width: 10,),
                        Container(
                          decoration: BoxDecoration(borderRadius: BorderRadius.circular(25), image: DecorationImage(fit: BoxFit.cover,image: AssetImage('assets/vanilla3.jpg'),)),
                          height: 100,
                          width: 100,
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Smallbutton(color1: Color(0xFF6c60e0),color2: Colors.white,name: 'Cancel',),
                          SizedBox(width: 15,),
                          Smallbutton(color1: Colors.white,color2: Color(0xFF6c60e0),name: 'Save',),
